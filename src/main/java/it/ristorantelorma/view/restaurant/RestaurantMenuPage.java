...
public final class RestaurantMenuPage {
    ...
    private void loadFoods() {
        ...
        final Result<Collection<Food>> result = Food.DAO.list(connection, restaurant);
        if (result.isSuccess()) {
    ...
    private void showAddDialog() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            try {
                ...
                final Result<Food> insertResult = Food.DAO.insert(connection, name, restaurant, price, type);
    ...
    private void deleteSelectedFood() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            final Result<Boolean> deleteResult = Food.DAO.delete(connection, foodId);
