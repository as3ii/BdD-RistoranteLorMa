...
public class RegisterPage {
    ...
    private static final Dimension BUTTON_RISTORANTE_DIMENSION = new Dimension(220, 35); // aggiungi questa riga
    ...
    private final JTextField telefonoField;   // aggiunto
    private final JTextField emailField;      // aggiunto
    private final JTextField creditoField;    // aggiunto
    ...
    public RegisterPage(final FirstPage parentPage) {
        ...
        this.telefonoField = new JTextField(15); // aggiunto
        this.emailField = new JTextField(15);    // aggiunto
        this.creditoField = new JTextField(15);  // aggiunto
    ...
    private void initializeFrame() {
        ...
        this.mainFrame.setSize(800, 700); // aumentata larghezza e altezza
    ...
    private void initializeUI() {
        freshPane(container -> {
            ...
            addFormField(formPanel, gbc, "Telefono:", telefonoField, 7);   // aggiunto
            addFormField(formPanel, gbc, "Email:", emailField, 8);         // aggiunto
            addFormField(formPanel, gbc, "Credito:", creditoField, 9);     // aggiunto
        ...
        telefonoField.getDocument().addDocumentListener(docListener); // aggiunto
        emailField.getDocument().addDocumentListener(docListener);    // aggiunto
        creditoField.getDocument().addDocumentListener(docListener);  // aggiunto
    ...
    private JPanel createButtonPanel() {
        ...
        registerRestaurantButton.setPreferredSize(BUTTON_RISTORANTE_DIMENSION); // imposta dimensione più grande
    ...
    private void updateRegisterButtonState() {
        boolean allFilled =
            ...
            !telefonoField.getText().trim().isEmpty() &&    // aggiunto
            !emailField.getText().trim().isEmpty() &&        // aggiunto
            !creditoField.getText().trim().isEmpty();        // aggiunto
    ...
    private void handleRegisterButtonClick() {
        ...
        String telefono = telefonoField.getText().trim(); // aggiunto
        String email = emailField.getText().trim();       // aggiunto
        double credito = 0.0;
        try {
            credito = Double.parseDouble(creditoField.getText().trim()); // aggiunto
    ...
    private void handleResetButtonClick() {
        ...
        civicoField.setText("");
        cittaField.setText("");
        telefonoField.setText("");   // aggiunto
        emailField.setText("");      // aggiunto
        creditoField.setText("");    // aggiunto
